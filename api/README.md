...
```toml
[dependencies]
tauri-plugin-android-fs = { version = "=25.1.1", features = ["legacy_storage_permission"] }
```
...
```bash
pnpm add tauri-plugin-android-fs-api@25.1.1 -E
# or
npm install tauri-plugin-android-fs-api@25.1.1 --save-exact
# or
yarn add tauri-plugin-android-fs-api@25.1.1 --exact
```
