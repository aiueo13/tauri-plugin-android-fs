...
```bash
pnpm add tauri-plugin-android-fs-api@24.2.1 -E
# or
npm install tauri-plugin-android-fs-api@24.2.1 --save-exact
# or
yarn add tauri-plugin-android-fs-api@24.2.1 --exact
```
